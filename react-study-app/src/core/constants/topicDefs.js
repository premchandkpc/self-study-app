const TOPIC_DEFS = [
  {
    id: 'dsa', abbr: 'dsa', label: 'DSA', icon: '\uD83E\uDDE9',
    meta: {
      color: 'blue',
    ...
    subtopics: [
      ...
      { name: 'TwoPointers', visualizer: 'array',
      ...
      { name: 'BinarySearch', visualizer: 'array',
      ...
      { name: 'PrefixSum', visualizer: 'array',
      ...
      { name: 'Matrices', visualizer: 'matrix',
      ...
      { name: 'LinkedList', visualizer: 'linkedlist',
      ...
      { name: 'Union Find', visualizer: 'unionfind',
      ...
      { name: 'Backtracking', visualizer: 'backtracking',
      ...
      { name: 'Strings', visualizer: 'string',
      ...
      { name: 'HashMaps', visualizer: 'hashmap',
      ...
      { name: 'Bubble Sort', visualizer: 'sorting',
      ...
      { name: 'Merge Sort', visualizer: 'sorting',
      ...
      { name: 'Quick Sort', visualizer: 'sorting',
      ...
      { name: 'Heap Sort', visualizer: 'sorting',
  ...
  {
    id: 'java', abbr: 'java', label: 'Java', icon: '\u2615',
    meta: {
      color: 'yellow',
    ...
    subtopics: [
      ...
      { name: 'Threads', visualizer: 'threads',
      ...
      { name: 'Collections', visualizer: 'java-collections',
      ...
      { name: 'Streams', visualizer: 'java-streams',
      ...
      { name: 'Classloader', visualizer: 'jvm',
      ...
      { name: 'String Pool', visualizer: 'jvm',
      ...
      { name: 'HashMap Internals', visualizer: 'jvm',
      ...
      { name: 'Exception Stack', visualizer: 'jvm',
  ...
  {
    id: 'spring', abbr: 'spring', label: 'Spring', icon: '\uD83C\uDF43',
    meta: {
      color: 'yellow',
    ...
    subtopics: [
      ...
      { name: 'Transactions', visualizer: 'spring',
      ...
      { name: 'Security', visualizer: 'spring',
      ...
      { name: 'AutoConfig', visualizer: 'spring',
  ...
  {
    id: 'golang', abbr: 'golang', label: 'Go', icon: '\uD83D\uDC39',
    meta: {
      color: 'blue',
    ...
    subtopics: [
      { name: 'Goroutines', visualizer: 'golang',
      ...
      { name: 'Channels', visualizer: 'golang',
      ...
      { name: 'Scheduler', visualizer: 'golang',
  ...
  {
    id: 'python', abbr: 'python', label: 'Python', icon: '\uD83D\uDC0D',
    meta: {
      color: 'blue',
    ...
    subtopics: [
      ...
      { name: 'Decorators', visualizer: 'python',
      ...
      { name: 'ML Pipelines', visualizer: 'python',
  ...
  {
    id: 'kubernetes', abbr: 'kubernetes', label: 'Kubernetes', icon: '\u2638\uFE0F',
    meta: {
      color: 'blue',
    ...
    subtopics: [
      { name: 'Pods', visualizer: 'kubernetes',
      ...
      { name: 'Deployments', visualizer: 'kubernetes',
      ...
      { name: 'Services', visualizer: 'kubernetes',
      ...
      { name: 'Ingress', visualizer: 'kubernetes',
      ...
      { name: 'HPA', visualizer: 'kubernetes',
      ...
      { name: 'Config & Storage', visualizer: 'kubernetes',
      ...
      { name: 'DNS', visualizer: 'kubernetes',
      ...
      { name: 'Sidecars', visualizer: 'kubernetes',
      ...
      { name: 'etcd', visualizer: 'kubernetes',
      ...
      { name: 'Node Failure', visualizer: 'kubernetes',
  ...
  {
    id: 'aws', abbr: 'aws', label: 'AWS', icon: '\u2601\uFE0F',
    meta: {
      color: 'orange',
    ...
    subtopics: [
      ...
      { name: 'API Gateway', visualizer: 'aws',
      ...
      { name: 'Step Functions', visualizer: 'aws',
      ...
      { name: 'Aurora / RDS', visualizer: 'aws',
      ...
      { name: 'ElastiCache', visualizer: 'aws',
  ...
  {
    id: 'kafka', abbr: 'kafka', label: 'Kafka', icon: '\uD83D\uDCE8',
    meta: {
      color: 'red',
    ...
    subtopics: [
      { name: 'Partitions', visualizer: 'kafka',
      ...
      { name: 'Consumer Groups', visualizer: 'kafka',
  ...
  {
    id: 'systemdesign', abbr: 'systemdesign', label: 'System Design', icon: '\uD83C\uDFD7\uFE0F',
    meta: {
      color: 'yellow',
    ...
    subtopics: [
      ...
      { name: 'Load Balancer', visualizer: 'systemdesign', scenarioId: 'lb',
      ...
      { name: 'Cache', visualizer: 'systemdesign', scenarioId: 'cache',
      ...
      { name: 'CDN', visualizer: 'systemdesign', scenarioId: 'cdn',
      ...
      { name: 'Rate Limiter', visualizer: 'systemdesign', scenarioId: 'rate-limiter',
      ...
      { name: 'Sharding', visualizer: 'systemdesign', scenarioId: 'sharding',
      ...
      { name: 'Replication', visualizer: 'systemdesign', scenarioId: 'replication',
      ...
      { name: 'Message Queue', visualizer: 'systemdesign', scenarioId: 'message-queue',
      ...
      { name: 'Raft Consensus', visualizer: 'systemdesign', scenarioId: 'raft',
  ...
  {
    id: 'microservices', abbr: 'microservices', label: 'Microservices', icon: '\uD83D\uDD0C',
    meta: {
      color: 'blue',
    ...
    subtopics: [
      { name: 'Load Balancer', visualizer: 'systemdesign',
      ...
      { name: 'Cache', visualizer: 'systemdesign',
      ...
      { name: 'CDN', visualizer: 'systemdesign',
      ...
      { name: 'Raft', visualizer: 'systemdesign',
      ...
      { name: 'Circuit Breaker', visualizer: 'microservices',
      ...
      { name: 'Service Discovery', visualizer: 'microservices',
      ...
      { name: 'API Gateway', visualizer: 'microservices',
      ...
      { name: 'Event-Driven', visualizer: 'microservices',
  ...
  {
    id: 'database', abbr: 'database', label: 'Database', icon: '\uD83D\uDDFC\uFE0F',
    meta: {
      color: 'yellow',
    ...
    subtopics: [
      { name: 'B-Tree', visualizer: 'database',
      ...
      { name: 'Query Planning', visualizer: 'database',
      ...
      { name: 'Transactions', visualizer: 'database',
      ...
      { name: 'Joins', visualizer: 'database',
  ...
  {
    id: 'redis', abbr: 'redis', label: 'Redis', icon: '\uD83D\uDD34',
    meta: {
      color: 'red',
    ...
    subtopics: [
      { name: 'Data Types', visualizer: 'redis',
      ...
      { name: 'Pipelining', visualizer: 'redis',
  ...
  {
    id: 'docker', abbr: 'docker', label: 'Docker', icon: '\uD83D\uDC33',
    meta: {
      color: 'blue',
    ...
    subtopics: [
      { name: 'Image Layers', visualizer: 'docker',
      ...
      { name: 'Container Lifecycle', visualizer: 'docker',
      ...
      { name: 'Networking', visualizer: 'docker',
      ...
      { name: 'Compose', visualizer: 'docker',
  ...
  {
    id: 'networking', abbr: 'networking', label: 'Networking', icon: '\uD83C\uDF10',
    meta: {
      color: 'purple',
    ...
    subtopics: [
      { name: 'TCP Handshake', visualizer: 'networking',
      ...
      { name: 'HTTP', visualizer: 'networking',
      ...
      { name: 'DNS', visualizer: 'networking',
      ...
      { name: 'Load Balancer', visualizer: 'networking',
  ...
  {
    id: 'os', abbr: 'os', label: 'Operating Systems', icon: '\uD83D\uDDA5\uFE0F',
    meta: {
      color: 'gray',
    ...
    subtopics: [
      ...
      { name: 'Virtual Memory', visualizer: 'os',
  ...
  {
    id: 'ai', abbr: 'ai', label: 'AI / Transformers', icon: '\uD83E\uDD16',
    meta: {
      color: 'green',
    ...
    subtopics: [
      { name: 'Transformer', visualizer: 'ai',
  ...
  {
    id: 'distributed', abbr: 'distributed', label: 'Distributed Systems', icon: '\uD83C\uDF0D',
    meta: {
      color: 'purple',
    ...
    subtopics: [
      { name: 'Raft', visualizer: 'distributed',
        explanation: `Consensus algorithm: leader elected, followers replicate log. Leader heartbeat: followers detect failure, elect new leader. Log entry replicated to majority before commitment. Strong leader: simplifies reasoning vs Paxos.`,
        useCases: ['Fault-tolerant consensus', 'Distributed databases', 'etcd/Consul'],
        realWorld: 'Kubernetes etcd: stores cluster state using Raft, survives minority node failures.',
        complexity: { election: '50-300ms', replication: 'Committed when quorum acks' } },
      { name: 'CAP Theorem', visualizer: 'distributed',
      ...
      { name: '2PC', visualizer: 'distributed',
  ...
  {
    id: 'concurrency', abbr: 'concurrency', label: 'Concurrency', icon: '\uD83E\uDDF5',
    meta: {
      color: 'purple',
    ...
    subtopics: [
      { name: 'Mutex', visualizer: 'concurrency',
      ...
      { name: 'Semaphore', visualizer: 'concurrency',
      ...
      { name: 'Producer-Consumer', visualizer: 'concurrency',
      ...
      { name: 'Deadlock', visualizer: 'concurrency',
