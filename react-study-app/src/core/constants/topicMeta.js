...
export const VISUALIZER_MAP = {
  ...
  'system-design:Uber Request Flow': 'uber',
  'system-design:Uber Architecture': 'uber',
  'system-design:Uber Failure Modes': 'uber',
  'system-design:Load Balancer':     'systemdesign',
  'system-design:Cache':             'systemdesign',
  'system-design:CDN':               'systemdesign',
  'system-design:Rate Limiter':      'systemdesign',
  'system-design:Sharding':          'systemdesign',
  'system-design:Replication':       'systemdesign',
  'system-design:Message Queue':     'systemdesign',
  'system-design:Raft Consensus':    'systemdesign',
  ...
  'dsa:Sets':                    'set',
  'dsa:Bubble Sort':             'sorting',
  'dsa:Merge Sort':              'sorting',
  'dsa:Quick Sort':              'sorting',
  'dsa:Heap Sort':               'sorting',
