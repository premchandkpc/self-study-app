export const TOPIC_META = {
  ...
  java:           { color: 'yellow', desc: 'JVM internals, GC algorithms, thread lifecycle, locks, collections — full simulation suite.' },
  ...
  kubernetes:     { color: 'blue',   desc: 'Pod scheduling, HPA, rolling deployments, Ingress, ConfigMaps, PV/PVC.' },
  aws:            { color: 'yellow', desc: 'EC2, Lambda, SQS, EKS, API Gateway, S3, IAM architecture flows.' },
